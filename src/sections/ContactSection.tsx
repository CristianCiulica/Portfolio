...
function GithubIcon({ size = 16 }: { size?: number }) {
  return (
    <svg {...brandIconProps} width={size} height={size}>
...
const SOCIALS = [
  { label: 'GitHub', href: 'https://github.com/CristianCiulica', Icon: GithubIcon },
  {
    label: 'LinkedIn',
    href: 'https://linkedin.com/in/cristian-ciulic%C4%83-66299038a',
    Icon: LinkedinIcon,
  },
  {
    label: 'Instagram',
